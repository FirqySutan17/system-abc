<div class="container-fluid">
    <div class="card w-100">
        <div class="card-body">
            ...
            <h5 class="card-title fw-semibold mb-4">ITEM BALANCE - INVENTORY</h5>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="mainTable">
                    <thead>
                        <tr>
                            <th rowspan="2" data-order="ITEM" style="text-align:center; vertical-align: middle">Item No</th>
                            <th rowspan="2" data-order="ITEM_NAME" style="text-align:center; vertical-align: middle">Nama</th>
