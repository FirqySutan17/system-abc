...
<script>
            ...
            function(r, index)
            {
                ...
                buttonRender = `<button
                            class="
                                ...
                                btn-sm
                                btnEdit"
                            onClick="triggerloanEdit('${r.LOAN_NO}')">
                        ...
                        <button
                            class="
                                ...
                                btn-sm
                                btnDelete"
                            onClick="triggerDelete('${r.LOAN_NO}')">
    ...
    */
    ...
    function generateLoanNo()
    {
        ...
        $.get(
            ...
            "<?= base_url('loan/generate_loan_no') ?>",
    ...
    */
    ...
    function resetSummaryAdd()
    {
        ...
        $('#loanDetailTableAdd tbody')
            .html('');
        $('#sumLoanAmount').html('0');
    }

    function resetSummaryEdit()
    {
        $('#sumLoanAmountEdit').html('0');
    }
    ...
    function triggerloanEdit(loanNo) {
        $.ajax({
            url:
                "<?= base_url('loan/edit') ?>",
            ...
            success:function(res)
            {
                if (res.status)
                {
                    ...
                    $("#IDNO_EDIT").val(header.LOAN_NO);
                    $("#LOAN_PLANT_EDIT").val(header.PLANT_NAME);
                    $("#LOAN_CUSTOMER_EDIT").val(header.CUSTOMER_NAME);
                    $("#LOAN_NO_EDIT").val(header.LOAN_NO);
                    $("#LOAN_DATE_EDIT").val(header.LOAN_DATE);
                    ...
                    if (details.length > 0) {
                        ...
                        $("#loanHistoryTableEdit tbody").html(htmlTableHistory);
                    }
    ...
    function loadLoanHistory() {
        ...
        $.ajax({
            url:
                "<?= base_url('loan/get_loan_history') ?>",
            type:'POST',
            data:{
                'plant': plant,
                'customer': customer
            ...
            success:function(res)
            {
                if (res.status)
                {
                    ...
                    if (data.length > 0) {
                        ...
                        $("#loanDetailTableAdd tbody").html(htmlTableHistory);
                    }
                    calculateSummary();
                }
            }
    ...
    function triggerDelete(loanNo) {
        $.ajax({
            url:
                "<?= base_url('loan/remove') ?>",
    ...
    function calculateSummary()
    {
        ...
        loanAmount += parseFloat($('#AMOUNT').val()) || 0;
    ...
    function calculateSummaryEdit()
    {
        ...
        loanAmount += parseFloat($('#AMOUNT_EDIT').val()) || 0;
