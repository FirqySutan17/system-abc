...
class ItemBalance extends MY_Controller {

    public function __construct()
    {
        parent::__construct();
        if (!has_permission('productions_item_balance')) {
            show_404();
        }
        $this->load->model('ItemBalance_model');
    ...
    {
        $this->load->view('templates/header', ['title' => 'Item Balance']);
        $this->load->view('templates/sidebar');
        $this->load->view('admin/item_balance/list');
